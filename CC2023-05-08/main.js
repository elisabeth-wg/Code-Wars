...
//R: Asks for various returns to test your knowledge of arrays - length, first, last, push, pop


//E: arr length --> arr.length
//   arr first element --> arr[0]
//   arr last element --> arr[arr.length-1]


//P: Check through each of the functions and return what is requested in their comments. Utilize methods like pop and push as apprpriate while useing indexing and .length for the others. 
