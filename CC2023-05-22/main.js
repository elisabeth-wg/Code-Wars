...
//P: Takes in two parameters - a string and a separator string


//R: Return the string separated by the separator that was passed in.


//E: ('Hi there', '-') --> 'H-i-t-h-e-r-e'
//   ('hello' ',') --> 'h,e,l,l,o'
//   ('beachtime' '.') --> 'b.e.a.c.h.t.i.m.e'

//P: Take in the string and the separator. Use the split method to separate into an array. Then join them back together using the indicated separator. Return the string. 
