...
//PREP:
//Takes in two parameters, both numbers. They could be absent.
//Returns a bolean or an error.
// console.log(match(candidate1, job1), true);
// console.log(match(canditate1,), 'error');
// console.log(match(candidate1, job2), false);
//let candidate1 = { minSalary: 120000 },
//job1 = { maxSalary: 130000 },
//job2 = { maxSalary: 80000 };
//It takes in two numbers. If either is absent return 'error'. If the candidate number is less than or equal to the job num return true, else return false. Will also need to account for the 10% wiggle room, noted above as being deducted from the candidate number.
