...
//P:  The function should take in 2 parameters. One for a string and the second with a number that tells how many * to pad the string with one the left and then the right side. 


//R: Return the string with * on the left and right side corresponding to the parameter n taken in - should start with left side.
...
//P: Take in two parameters to function. Loop through with a while loop as specified - and add * one each interation. Left then right. until reaching the parameter n. write a conditional with modulus, if iteration is odd add on left, if even add to right side. return the string at the end. 
